...
export function EditMemberForm({ member, language, onSuccess, onCancel }: EditMemberFormProps) {
  ...
  const form = useForm<MemberFormData>({
    ...
    defaultValues: {
      ...
      title: member.title || "",
      titleJa: member.titleJa || "",
      company: member.company || "",
      companyJa: member.companyJa || "",
      bio: member.bio || "",
      bioJa: member.bioJa || "",
          ...
          <div className="border-t pt-6">
            ...
            <div className="space-y-2 mb-4">
              ...
              <Input
                ...
                placeholder="氏名を入力"
                data-testid="input-edit-member-name-ja"
              />
            </div>
            ...
            <div className="space-y-2 mb-4">
              ...
              <Input
                ...
                placeholder="役職を入力"
                data-testid="input-edit-member-title-ja"
              />
            </div>
            ...
            <div className="space-y-2 mb-4">
              ...
              >
                <SelectTrigger data-testid="select-edit-member-company-ja">
            ...
            <div className="space-y-2">
              ...
              <Textarea
                ...
                rows={4}
                data-testid="textarea-edit-member-bio-ja"
              />
              <div className="flex justify-between items-center text-sm">
