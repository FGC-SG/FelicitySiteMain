...
- **Data Export & Import**: 
    ...
    - **SharePoint Integration**: Database backups automatically upload to SharePoint FGCSite (Shared Documents/DatabaseBackups folder) with automatic fallback to local download if upload fails. Uses Microsoft Graph API with OAuth authentication.
