...
- **Content Management**:
    - **News**: Comprehensive view, add, edit, and delete functionality for news articles, with full bilingual support (title and content fields only) and "Read More" modals. News articles support SharePoint embed URLs that display files in an embedded viewer without exposing the SharePoint URL to visitors. Includes TinyURL shortening for easy sharing of the embedded viewer. Includes AI-powered bilateral translation (EN↔JP) using Gemini AI for instant translation of titles and content in both directions.
...
- **AI Translation**: Gemini AI (Google) for bilateral EN↔JP translation