...
- **Content Management**:
    - **News**: Comprehensive view, add, edit, and delete functionality for news articles, with full bilingual support (title and content fields only) and "Read More" modals. News articles support SharePoint file URL attachments with TinyURL shortening for easy sharing - visitors can view files and generate shortened share links. Includes AI-powered bilateral translation (EN↔JP) using Gemini AI for instant translation of titles and content in both directions.
