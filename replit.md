...
- 2025-09-23: Implemented Fund visibility control system in Fund Management page - added isVisible field to funds schema, visibility checkboxes with Eye/EyeOff icons and status badges, real-time visibility toggling with success notifications, and automatic filtering of public Fund page to show only visible funds
